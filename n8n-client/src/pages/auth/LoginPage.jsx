...
const LoginPage = () => {
  ...
  const { progressStart, progressComplete, progressReset } =
    useLoadingProgress();
        ...
        <Animate>
          <MPaper
            sx={{
              ...
              boxShadow:
                "0 20px 50px rgba(15, 118, 110, 0.15), 0 5px 15px rgba(0,0,0,0.05)",
            }}
          >
            <IconButton
            ...
            <Box component="form" onSubmit={form.handleSubmit}>
              <StackCol gap={0}>
                <StackCol gap={1.2} sx={{ mb: 3 }}>
                  <StackRow sx={{ justifyContent: "center" }}>
                    <Logo />
                  </StackRow>
                ...
                <StackCol gap={0} sx={{ mb: 3 }}>
                  ...
                  <Box sx={{ width: "100%" }}>
                    ...
                    <StackRow sx={{ justifyContent: "flex-end", mt: 2 }}>
                      <TypographyLink
            ...
            >
              ...
              <TypographyLink to="/register">Sign up for free</TypographyLink>
            </Typography>
          </MPaper>
        </Animate>
      </Container>
